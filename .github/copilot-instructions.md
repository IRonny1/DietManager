## Copilot most important rules for this repository
- Always ask multiple questions to understand the context of the code and the author's intentions before suggesting any code changes.
- Always explain the reasoning behind architectural decisions and code suggestions.
- Always think about the long-term maintainability and scalability of the codebase when making suggestions.
- Always suggest improvements that align with the project's overall architecture and coding standards.
